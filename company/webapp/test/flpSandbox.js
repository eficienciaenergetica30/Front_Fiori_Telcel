		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Compañías",
									"targetURL": "#globalhitsseecompany-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globalhitsseecompany-display": {
								"semanticObject": "globalhitsseecompany",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globalhitss.ee.company",
									"url": sap.ui.require.toUrl("globalhitss/ee/company")
								}
							}
						}
					}
