		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Zonas",
									"targetURL": "#globalhitsseezone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globalhitsseezone-display": {
								"semanticObject": "globalhitsseezone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globalhitss.ee.zone",
									"url": sap.ui.require.toUrl("globalhitss/ee/zone")
								}
							}
						}
					}
