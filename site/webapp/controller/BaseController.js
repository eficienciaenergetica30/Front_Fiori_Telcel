        ...
        getDataWizard: function() {
            ...
            return new Promise(function(fnResolve, fnReject) {
                let data = {
                    ...
                    Corporation: that.byId("companyComboBox").getSelectedItem().getText(),
                    Fare: that.byId("siteFareInput").getValue(),
                    Region: that.byId("siteRegionInput").getValue(),
                    ExternalId: that.byId("externalIdInput").getValue(),
                    ...
                    AddressCFE: that.byId("addressCFEInput").getValue(),
