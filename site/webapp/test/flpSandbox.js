		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sitios",
									"targetURL": "#globalhitsseesite-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globalhitsseesite-display": {
								"semanticObject": "globalhitsseesite",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globalhitss.ee.site",
									"url": sap.ui.require.toUrl("globalhitss/ee/site")
								}
							}
						}
					}
