		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sensores",
									"targetURL": "#globalhitsseesensor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"globalhitsseesensor-display": {
								"semanticObject": "globalhitsseesensor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=globalhitss.ee.sensor",
									"url": sap.ui.require.toUrl("globalhitss/ee/sensor")
								}
							}
						}
					}
